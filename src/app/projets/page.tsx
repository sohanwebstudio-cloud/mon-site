  ...
  return (
    <div className="pt-32 pb-20 px-6 min-h-screen">
      <div className="container mx-auto">
        ...
        <p className="text-white text-lg max-w-2xl">Découvrez mes récentes réalisations et comment j&apos;ai aidé mes clients à transformer leur présence en ligne.</p>
          ...
          {projets.map((projet) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-white group-hover:text-zinc-100 transition-colors">
                  {projet.desc}
                </p>
              </div>
            </Link>
