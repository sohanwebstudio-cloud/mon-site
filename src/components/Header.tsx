...
>
  ...
  <div className="w-full px-4 md:px-12 flex items-center justify-between">
    {/* Logo : Taille contrôlée et limitée */}
    <Link href="/" className="relative z-50 shrink-0 w-[150px] sm:w-[200px] lg:w-auto">
      <Image 
        src="/logo.png" 
    ...
    {/* Ajout de ml-auto pour forcer l'alignement à droite sans déborder */}
